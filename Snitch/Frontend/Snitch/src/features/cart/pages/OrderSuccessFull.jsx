...
const OrderSuccessFull = () => {
  ...
  return (
    <div
      className="min-h-screen bg-black text-white flex items-center justify-center px-4 py-20"
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-indigo-600/10 rounded-full blur-[120px] animate-pulse"
      ...
      <div className="max-w-2xl w-full relative z-10">
        <div className="bg-zinc-900/50 border border-zinc-800 backdrop-blur-xl rounded-[2.5rem] p-8 md:p-12 shadow-2xl text-center">
          ...
          <div className="relative mb-8 inline-block">
            ...
            <div className="relative bg-liner-to-tr from-indigo-600 to-indigo-400 p-6 rounded-full shadow-lg shadow-indigo-500/40">
              <CheckCircle2
                size={64}
          ...
          <div className="space-y-4 mb-12">
            ...
            <p className="text-zinc-400 text-lg max-w-md mx-auto">
              Thank you for your purchase. Your premium collection items are
